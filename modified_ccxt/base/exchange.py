...
from modified_ccxt.base.errors import RequestTimeout
...
class Exchange(object):
    ...
    def __init__(self, config={}):
        ...
        self.userAgent = {
            'User-Agent': 'modified_ccxt/' + __version__ + ' (+https://github.com/modified_ccxt/modified_ccxt) Python/' + version
        }
    ...
    #btcturk fetch_balance buradan cagriliiyor
    ...
    def iso8601(timestamp):
        ...
        except Exception as e: #We added this except situation because btcturk timestamps makes error.. This turkish..
            utc = datetime.datetime.utcfromtimestamp(int(round(timestamp / (1000000))))
    ...
    def parse_bid_ask(self, bidask, price_key=0, amount_key=0):
        ...
        total = price * amount
        ret = [price , amount , total]
        return  ret
    def parse_bids_asks(self, bidasks, price_key=0, amount_key=1):
        ret =  [self.parse_bid_ask(bidask, price_key, amount_key) for bidask in bidasks]
        return ret
